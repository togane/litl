...
function twentynineteen_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( '4-archive', 'twentynineteen' ),
			'id'            => 'sidebar-4',
	...
	register_sidebar(array(
			'id' => 'sidebar-3',
			'name' => '3-footer-menu',
			'description' => 'Appears at the top of the content on posts and pages.',
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
		));
	
	register_sidebar( array(
        'name'          => __( '1-Sidebar', 'twentysixteen' ),
        'id'            => 'sidebar-1',
    ...
    register_sidebar( array(
        'name'          => __( '2-category', 'twentysixteen' ),
        'id'            => 'sidebar-2',
        'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
        'before_widget' => '<section id="categories-2" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h2 class="widget-title">',
        'after_title'   => '</h2>',
    ) );
...
function twentynineteen_scripts() {
	...
	wp_enqueue_script( 'swiper.min.js', get_template_directory_uri().'/js/swiper.min.js','jquery', '',false);
...
add_theme_support( 'editor-color-palette', array(
  ...
  array(
	...
	array(
    'name'  => __( 'カラー１', 'genesis-sample' ),
    'slug'  => 'color1',
    'color' => '#e36b6d',
       ),
  array(
    'name'  => __( 'カラー２', 'genesis-sample' ),
    'slug'  => 'color2',
    'color' => '#6b9de3',
       ),
  array(
    'name'  => __( 'カラー３', 'genesis-sample' ),
    'slug'  => 'color3',
    'color' => '#7d6be3',
       ),
   array(
    'name'  => __( 'カラー４', 'genesis-sample' ),
    'slug'  => 'color4',
    'color' => '#e3836b',
       ),
   array(
    'name'  => __( 'カラー５', 'genesis-sample' ),
    'slug'  => 'color5',
    'color' => '#de81ce',
       ),
) );
