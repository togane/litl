...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'leanex-lite' ), // Required
...
$panels[] = array(
	'id' => $panel,
	'title' => __( 'Panel Examples', 'leanex-lite' ),
	'priority' => '100'
);
...
$sections[] = array(
	'id' => $section,
	'title' => __( 'Panel Section', 'leanex-lite' ),
	'priority' => '10',
	'panel' => $panel
);
...
$options['example-panel-text'] = array(
	...
	'label'   => __( 'Example Text Input', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-select'] = array(
	'id' => 'example-select',
	'label'   => __( 'Example Select', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'select',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-radio'] = array(
	'id' => 'example-radio',
	'label'   => __( 'Example Radio', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'radio',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-upload'] = array(
	'id' => 'example-upload',
	'label'   => __( 'Example Upload', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'upload',
	'default' => '',
);
...
$options['example-color'] = array(
	'id' => 'example-color',
	'label'   => __( 'Example Color', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'color',
	'default' => $color // hex
);
...
$options['example-textarea'] = array(
	'id' => 'example-textarea',
	'label'   => __( 'Example Textarea', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'textarea',
	'default' => __( 'Example textarea text.', 'leanex-lite'),
);
~~~
...
$options['example-font'] = array(
	'id' => 'example-font',
	'label'   => __( 'Example Font', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'select',
...
$options['example-range'] = array(
	'id' => 'example-range',
	'label'   => __( 'Example Range Input', 'leanex-lite' ),
	'section' => $section,
	'type'    => 'range',
	'input_attrs' => array(
        'min'   => 0,
...
$options['example-content'] = array(
	'id' => 'example-content',
	'label' => __( 'Example Content', 'leanex-lite' ),
	'section' => $section,
	'type' => 'content',
	'content' => '<p>' . __( 'Content to output. Use <a href="#">HTML</a> if you like.', 'leanex-lite' ) . '</p>',
	'description' => __( 'Optional: Example Description.', 'leanex-lite' )
);
~~~
