...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Standard Fonts', 'leanex-lite' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Google Fonts', 'leanex-lite' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => esc_html__( 'All', 'leanex-lite' ),
		'cyrillic'     => esc_html__( 'Cyrillic', 'leanex-lite' ),
		'cyrillic-ext' => esc_html__( 'Cyrillic Extended', 'leanex-lite' ),
		'devanagari'   => esc_html__( 'Devanagari', 'leanex-lite' ),
		'greek'        => esc_html__( 'Greek', 'leanex-lite' ),
		'greek-ext'    => esc_html__( 'Greek Extended', 'leanex-lite' ),
		'khmer'        => esc_html__( 'Khmer', 'leanex-lite' ),
		'latin'        => esc_html__( 'Latin', 'leanex-lite' ),
		'latin-ext'    => esc_html__( 'Latin Extended', 'leanex-lite' ),
		'vietnamese'   => esc_html__( 'Vietnamese', 'leanex-lite' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'opensans' => array(
			'label' => esc_html_x( 'Open Sans', 'font style', 'leanex-lite' ),
			'stack' => '"Open Sans", Helvetica, Arial, sans-serif'
		),
		'verdana' => array(
			'label' => esc_html_x( 'Verdana', 'font style', 'leanex-lite' ),
			'stack' => 'Verdana, Geneva, sans-serif'
		),
		'monospace' => array(
			'label' => esc_html_x( 'Monospaced', 'font style', 'leanex-lite' ),
