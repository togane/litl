...
if ( ! function_exists( 'customizer_library_sanitize_content' ) ) :
/**
 * Add DT
 */
function customizer_library_sanitize_textarea( $string ) {
...
if ( ! function_exists( 'customizer_library_sanitize_hex_color' ) ) :
/**
 ...
 * @return string|null
 */
function customizer_library_sanitize_hex_color( $color ) {
	if ( '' === $color ) {
		return '';
	}
...
if ( ! function_exists( 'customizer_library_multicheck_sortable_sanitaze' ) ) :
/**
 * Sanitizes a Muticheck Sortable
 * @added DT
 */
function customizer_library_multicheck_sortable_sanitaze( $input ) {

	/* Var */
	$output = array();

	/* Get valid services */
	$valid_sorters = leanex_lite_sorter();
